...
interface Props {
    isSelected : DocumentData,
    setSelected : Dispatch<SetStateAction<DocumentData>>|any
}
...
export const More = ({isSelected, setSelected} : Props) => {
    ...
    return (
        <div className="fixed inset-0 z-40 backdrop-blur-lg p-6 overflow-y-scroll">
            ...
            <section className="max-w-3xl m-auto text-base overflow-hidden rounded-2xl">
                <motion.div 
                ...
                <motion.div
                    ...
                    className="bg-gray-50 dark:bg-neutral-700 p-6">
                    ...
                    <ul>
                        {isSelected.features.map((feature : string, idx:string)=>(
                            <li key={idx}>{feature}</li>
                        ))}
                    </ul>
                    <h2 className="text-2xl font-bold gradient-text mb-2 mt-6">Project Links</h2>
                    <div className="flex gap-2">
                        <Link href={isSelected.github} className="flex gap-1 items-center">
                            <FaGithub size={20}/>
                            <p>Source Code</p>
                        </Link>
                        <Link href={isSelected.link} className="flex gap-1 items-center">
